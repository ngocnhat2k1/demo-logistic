...
const ROLE_META: Record<
    UserRole,
    { label: string; icon: React.ElementType; subtitle: string; color: string }
> = {
    ADMIN: {
    ...
    OPS_MANAGER: {
        ...
        icon: UserCog,
        subtitle: "Giám sát điều phối + báo cáo",
        color: "bg-purple-50 text-purple-600",
    },
    DISPATCHER: {
        label: "Điều độ viên",
        icon: Briefcase,
        subtitle: "Phân xe, theo dõi đơn",
        color: "bg-blue-50 text-blue-600",
    },
    SALES: {
        label: "Kinh doanh",
        icon: Users2,
        subtitle: "Tạo đơn cho khách",
        color: "bg-amber-50 text-amber-600",
    },
    CUSTOMER: {
        label: "Khách hàng",
        icon: Building2,
        subtitle: "Theo dõi đơn và hạn mức",
        color: "bg-cyan-50 text-cyan-700",
    },
    DRIVER: {
        label: "Tài xế",
        icon: Truck,
        subtitle: "App di động (giả lập)",
